...
#include "common/Fused_kernels.cu"
					...
					int alex_num, int res_num)
{
    ...
    for(int j = 0; j < alex_num; j++){
        ...
        FILE *list_alex = fopen("common/imagenet1000_clsidx_to_labels.txt","rt");
	...
	for(int j = 0; j < res_num; j++){
        ...
        FILE *list_res = fopen("common/imagenet1000_clsidx_to_labels.txt","rt");
						...
						float *Vgg_Layer13_pool,float *Vgg_Result_Neurons,int vgg_num)
{
    ...
    for(int j = 0; j < vgg_num; j++){   
        ...
        FILE *list_vgg = fopen("common/imagenet1000_clsidx_to_labels.txt","rt");
